...
> Return a tuple $(r, U)$ consisting of the rank $r$ and $U$, the right rational
> nullspace of $x$, i.e. a set of vectors over $\mathbb{Z}$ giving a $\mathbb{Q}$-basis 
> for the nullspace of $x$ considered as a matrix over $\mathbb{Q}$.
"""
